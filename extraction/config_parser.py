...
For now, extracts the game description and available actions from a single
fmri-gym game config.

This is currently game-specific because config formatting is not yet fully
